...
use app\back\model\ConfigGroup;
use app\back\validate\ConfigGroupValidate;
...
class ConfigGroupController extends Controller
{
    ...
    public function setAction($id = null)
    {
        ...
        if ($request->isGet()) {
            ...
            $data = Session::get('data') ?: (!is_null($id)?Db::name('config_group')->find($id) : []);
...
//                重定向到创建表单
    ...
    {
        # 先获取空的查询构建器
        $builder = ConfigGroup::where(null);
